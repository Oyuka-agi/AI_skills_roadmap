# AI_skills_roadmap
     ...
     **Using machine learning to identify professional skill gaps and automate
      personalized career learning roadmaps.**
    
     ---
    
     ##  Project Overview
     The **Career Roadmap App** is an interactive, AI-powered platform designed
    ...
    ##  Model Logic
 Detailed technical documentation for our core models can be found in the
     `docs/` directory:
